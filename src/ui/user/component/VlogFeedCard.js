...
function VlogFeedCard({ vlogData }) {
   ...
   const [optionsMenuVisible, setOptionsMenuVisible] = useState(false);
    ...
    return (
        <Card theme={{roundness: 10}} style={{width: Dimensions.get('window').width - 20, borderRadius: 20, elevation: 5, marginBottom: 15}}>
                        <Card.Cover theme={{roundness: 10}} style={{elevation: 0, height: 180, borderRadius: 0}} source={{uri: 'https://picsum.photos/200/'}} />

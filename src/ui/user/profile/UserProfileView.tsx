 ...
 */
class UserProfileView extends React.Component<IProfileProps, IProfileState> implements ServicedComponent {
        ...
        return (
            <View style={styles.container}>
                ...
                {/* UserInfo Container */}
                            ...
                            <View style={{height: 'auto', paddingTop: 10, backgroundColor: '#FFFFFF', width: '100%'}}>
                                {/* Avatar/Following */}

                                <View style={{paddingVertical: 10, width: '100%', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-evenly'}}>
                                        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
                                        {this.getUserAvatar()}
                                        </View>
                                ...
                                <View style={{marginVertical: 10, width: '100%', flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-evenly'}}>
                            ...
                            <TouchableOpacity onPress={() => this._navigateToFollowers()}>
                                <View style={{alignItems: 'center', justifyContent: 'center'}}>
                                    ...
                                    <Text style={{fontSize: 12, fontFamily: 'HelveticaNeue', fontWeight: '400'}}>
                         {
                            ...
                            this.state.userData.bio
                                ...
                                <Divider style={{height: 10, backgroundColor: 'rgb(247, 247, 247)'}} />
                            ...
                            <Text style={{fontFamily: 'Avenir-Medium', fontSize: 15, color: '#1089ff'}}>

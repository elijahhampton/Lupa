...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../node_modules/react-native-vector-icons/Fonts/Helvetica Neu Bold.ttf"
  install_resource "${PODS_ROOT}/../../node_modules/react-native-vector-icons/Fonts/HelveticaNeue BlackCond.ttf"
  install_resource "${PODS_ROOT}/../../node_modules/react-native-vector-icons/Fonts/HelveticaNeue Light.ttf"
  install_resource "${PODS_ROOT}/../../node_modules/react-native-vector-icons/Fonts/HelveticaNeue Medium.ttf"
  install_resource "${PODS_ROOT}/../../node_modules/react-native-vector-icons/Fonts/HelveticaNeue Thin.ttf"
  install_resource "${PODS_ROOT}/../../node_modules/react-native-vector-icons/Fonts/HelveticaNeue.ttf"
  install_resource "${PODS_ROOT}/../../node_modules/react-native-vector-icons/Fonts/HelveticaNeueBd.ttf"
  install_resource "${PODS_ROOT}/../../node_modules/react-native-vector-icons/Fonts/HelveticaNeueHv.ttf"
  install_resource "${PODS_ROOT}/../../node_modules/react-native-vector-icons/Fonts/HelveticaNeueIt.ttf"
  install_resource "${PODS_ROOT}/../../node_modules/react-native-vector-icons/Fonts/HelveticaNeueLt.ttf"
  install_resource "${PODS_ROOT}/../../node_modules/react-native-vector-icons/Fonts/HelveticaNeueMed.ttf"
